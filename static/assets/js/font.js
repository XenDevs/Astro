  ...
  (t => {
    ...
    function t(t, e) {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        e && (o = o.filter(e => Object.getOwnPropertyDescriptor(t, e).enumerable)),
          n.push.apply(n, o);
      }
      return n;
    }
    ...
    function p(t, e) {
      ...
      try {
        if (t === e)
          throw TypeError("A promises callback cannot return that same promise.");
    ...
    (_.prototype = {
      ...
      then: function (t, e) {
        ...
        return (
          (!e && !t) ||
            this._handled ||
            ((this._handled = !0), "rejected" === this._state && f && h(A, this)),
                  ...
                  F(
                    ...
                    .then(t => {
                      ...
                      o(
                        ...
                        void 0 !== c &&
                          r.setAttribute("data-auto-a11y", c ? "true" : "false"),
                        a &&
                          (r.setAttributeNode(
